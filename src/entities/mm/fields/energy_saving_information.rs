...
use crate::entities::mm::enums::energy_saving_mode::{self, EnergySavingMode};
...
impl EnergySavingInformation {
    pub fn from_bitbuf(buffer: &mut BitBuffer) -> Result<Self, PduParseErr> {
        ...
        let energy_saving_mode = energy_saving_mode::EnergySavingMode::try_from(val as u64).unwrap(); // Never fails
